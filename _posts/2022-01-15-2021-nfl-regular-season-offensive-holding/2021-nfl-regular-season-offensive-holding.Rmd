...
The totals below include all called holding penalties, even if declined or offset by another penalty. Plays identified as QB scrambles are counted as "pass" play calls.
